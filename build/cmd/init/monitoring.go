...
var HostMonitoring = Join(
	Host("monitoring",
		...
		Gateway("10.101.0.1"),
		Bridge("igw", "02:00:00:00:02:01", IPs("10.101.0.6/24")),
		container.New("cache",
	...
	Container("cache",
		Network("02:00:00:00:02:02", "igw", IPs("10.101.0.7/24")),
		Gateway("10.101.0.1"),
	...
	Container("grafana",
		Network("02:00:00:00:02:03", "igw", IPs("10.101.0.8/24")),
		Gateway("10.101.0.1"),
		shield.Open("tcp4", "igw", grafana.Port),
		grafana.Container("grafana",
			grafana.DataSource("Prometheus", grafana.DataSourcePrometheus, "http://10.101.0.9:"+strconv.Itoa(prometheus.Port)),
			grafana.DataSource("Loki", grafana.DataSourceLoki, "http://10.101.0.10:"+strconv.Itoa(loki.Port)),
			grafana.Dashboards(host.DashboardBoxes, eye.Dashboard),
		),
	),
	Container("prometheus",
		Network("02:00:00:00:02:04", "igw", IPs("10.101.0.9/24")),
		Gateway("10.101.0.1"),
		shield.Open("tcp4", "igw", prometheus.Port),
		prometheus.Container("prometheus"),
	),
	Container("loki",
		Network("02:00:00:00:02:05", "igw", IPs("10.101.0.10/24")),
		Gateway("10.101.0.1"),
